...
# --- TẠO WEB SERVER GIẢ LẬP ĐỂ CHẠY TRÊN RENDER ---
app = Flask('')
...
async def taixiu(ctx):
    ...
    # 2. Phát âm thanh "Mời bạn bắt đầu cá cược" ở luồng riêng
    if vc:
    ...
    # 4. KHÓA TẤT CẢ NÚT BẤM (Gửi view cập nhật lên Discord)
...
# Chạy web server ngầm trước, sau đó chạy bot
if __name__ == '__main__':
    keep_alive()
    TOKEN = os.environ.get('DISCORD_TOKEN')
    if TOKEN:
        bot.run(MTU1MTg0OTAyNjgwOTIzNzU1NQ)
